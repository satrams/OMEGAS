    ...
    def render(
        ...
        if override_color is None:
            if convert_SHs_python:
                shs_view = self.gaussians.get_features.transpose(1, 2).view(-1, 3, (pc.max_sh_degree+1)**2)
                dir_pp = (self.gaussians.get_xyz - viewpoint_camera.camera_center.repeat(pc.get_features.shape[0], 1))
