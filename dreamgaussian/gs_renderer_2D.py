...
from gaussian_splatting.utils.sh_utils import eval_sh, SH2RGB
...
class Renderer:
    ...
    def initialize(self, input=None, num_pts=5000, radius=0.5, depth_ratio=1.0):
        # load checkpoint
